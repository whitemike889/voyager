...
Here, port 8080 will serve client's request and port 9090 will be used for agent-check.
...
```console
$ kubectl annotate svc test-server ingress.appscode.com/agent-port="9090"
```
